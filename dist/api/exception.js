...
const VouchExceptions = {
    ...
    INVALID_VOUCH_PROOF_ACTIVITY_BODY: {
        error: 400,
        message: 'To change vouch proof state you must provide a valid activity body with "who"'
    },
...
let APIException = class APIException extends _common.HttpException {
    constructor(type){
        super(VouchExceptions[type], _common.HttpStatus.BAD_GATEWAY);
    }
};
